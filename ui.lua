if (game:GetService("CoreGui")):FindFirstChild("NightX hub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).NightX hub:Destroy();
...
ImageButton.Image = "rbxassetid://91881585928344";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("NightX hub")).Enabled = not (game.CoreGui:FindFirstChild("NightX hub")).Enabled;
end);
...
function Update:StartLoad()
	...
	TitleLoader.Text = "NightX hub[BF]";
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("NightX hub") then
			makefolder("NightX hub");
		end;
		if not isfolder("Nightx hub/Library/") then
			makefolder("NightX hub/Library/");
		end;
		if not isfile(("NightX hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("NightX hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("NightX hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("NightX hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("NightX hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	CreateButton("Reset Config", function()
		if isfolder("NightX hub") then
			delfolder("NightX hub");
		end;
	...
	UserInputService.InputBegan:Connect(function(input)
		if input.KeyCode == Enum.KeyCode.Insert then
			(game.CoreGui:FindFirstChild("NightXHub")).Enabled = not (game.CoreGui:FindFirstChild("NightXHub")).Enabled;
		end;
	end);
