if (game:GetService("CoreGui")):FindFirstChild("tên hub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Tên hub:Destroy();
...
ImageButton.Image = "rbxassetid://138702426985173";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("tên hub")).Enabled = not (game.CoreGui:FindFirstChild("tên hub")).Enabled;
end);
...
function Update:StartLoad()
	...
	TitleLoader.Text = "Tên hub của bạn";
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Tên hub") then
			makefolder("Tên hub");
		end;
		if not isfolder("tên hub/Library/") then
			makefolder("tên hub/Library/");
		end;
		if not isfile(("tên hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("tên hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("tên hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("tên hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("tên hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local tên hub = Instance.new("ScreenGui");
	tên hub.Name = "Tên hub của bạn";
	tên hub.Parent = game.CoreGui;
	tên hub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = tên hub;
